...
test('the voice TOOL SCHEMA is byte-identical to main — the mission mapping is instructions only', () => {
  ...
  assert.equal(block.length, 31218, 'tool schema byte length drifted from the pinned release schema');
  assert.equal(
    crypto.createHash('sha256').update(block).digest('hex'),
    'bdc78e341f09c9a8deeb9b2752c37f3cfeba1761f502dc26950a55e843254dc4',
